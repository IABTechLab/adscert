...
type AdsCertSignatoryClient interface {
	NoOperationResponse(ctx context.Context, in *AuthenticatedConnectionSignatureRequest, opts ...grpc.CallOption) (*AuthenticatedConnectionSignatureResponse, error)
...
func (c *adsCertSignatoryClient) NoOperationResponse(ctx context.Context, in *AuthenticatedConnectionSignatureRequest, opts ...grpc.CallOption) (*AuthenticatedConnectionSignatureResponse, error) {
	out := new(AuthenticatedConnectionSignatureResponse)
	err := c.cc.Invoke(ctx, "/api.AdsCertSignatory/NoOperationResponse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdsCertSignatoryServer interface {
	NoOperationResponse(context.Context, *AuthenticatedConnectionSignatureRequest) (*AuthenticatedConnectionSignatureResponse, error)
...
func (UnimplementedAdsCertSignatoryServer) NoOperationResponse(context.Context, *AuthenticatedConnectionSignatureRequest) (*AuthenticatedConnectionSignatureResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NoOperationResponse not implemented")
}
...
func _AdsCertSignatory_NoOperationResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthenticatedConnectionSignatureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdsCertSignatoryServer).NoOperationResponse(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.AdsCertSignatory/NoOperationResponse",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdsCertSignatoryServer).NoOperationResponse(ctx, req.(*AuthenticatedConnectionSignatureRequest))
	}
...
var AdsCertSignatory_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NoOperationResponse",
			Handler:    _AdsCertSignatory_NoOperationResponse_Handler,
		},
		{
